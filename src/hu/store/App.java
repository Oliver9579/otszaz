...
public class App {
    ...
    private void run() {
        System.out.println("2. feladat:\n A fizetések száma: " + cartService.getCartNumber());
        System.out.println("3. feladat:\n Az első vásárló " + cartService.getGoodsNumberInCart(1) + " darab árucikket vásárolt");
        System.out.print("4. feladat: ");
        System.out.print("Adja meg egy vásásrlás sorszámát! ");
        int id = console.readInt();
        System.out.print(" Adja megy egy árucikk nevét! ");
